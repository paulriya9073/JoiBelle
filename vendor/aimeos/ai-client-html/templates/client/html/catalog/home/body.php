				...
				<?php if (!($mediaItems = $child->getRefItems('media', 'stage', 'default'))->isEmpty()): ?>
						...
						<div class="home-stage catalog-stage-image">
							<a class="stage-item row" href="">
								<img class="stage-image" loading="true"
									src="https://cdn.shopify.com/s/files/1/1338/0845/files/FRonCP-banner-desktop.jpg?v=1581807446"
									srcset="" alt="">
							</a>
						</div>
					</div>
					...
					<div class="home-item cat-image ">
						<div class="home-stage catalog-stage-image">
							<a class="stage-item row" href="">
								<img class="stage-image" loading="true"
									src="https://shop-beauty.dior.ae/cdn/shop/files/Xmas_22_Gift_Finder_1440x617_1.jpg?v=1667554105"
									srcset="" alt="">
							</a>
						</div>
					</div>
					...
					<div class="home-item cat-image ">
						<div class="home-stage catalog-stage-image">
							<a class="stage-item row" href="">
								<img class="stage-image" loading="true"
									src="https://i.pinimg.com/originals/55/22/cc/5522cc007ff8023d437cee990e92b6a9.jpg"
									srcset="" alt="">
							</a>
						</div>
					</div>
